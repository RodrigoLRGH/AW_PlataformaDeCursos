...
function EditCoursePage() {
    ...
    const { register, handleSubmit, reset, setValue, watch, formState: { errors, isSubmitting }, setError } = useForm<EditCourseFormData>({
    ...
    if (loading) return <p className="text-center py-12 text-secundario">Cargando...</p>
    ...
    return (
        <div className="min-h-screen bg-fondo">
            <nav className="bg-fondo-claro shadow px-8 py-4 flex justify-between items-center">
                    ...
                    <h1 className="text-xl font-bold text-primario">Editar curso</h1>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            <div className="space-y-1">
                                <Label htmlFor="title">TTitulo</Label>
