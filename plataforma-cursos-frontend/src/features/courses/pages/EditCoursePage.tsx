...
const schema = z.object({
  ...
  price: z.number().min(1, "El precio debe ser al menos 1").optional(),
...
function EditCoursePage() {
  ...
  const onSubmit = async (data: EditCourseFormData) => {
    ...
    try {
      ...
      await courseService.update(Number(id), cleanData);
  ...
  if (loading)
    return <p className="text-center py-12 text-secundario">Cargando...</p>;
