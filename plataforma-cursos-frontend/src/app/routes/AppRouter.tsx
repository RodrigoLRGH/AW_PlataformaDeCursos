    ...
    return (
        <BrowserRouter>
            <Routes>
                ...
                <Route path='/unauthorized' element={<h1>No tienes permiso de acceder a esta pagina</h1>} />
                ...
                <Route path='/creator/courses/:courseId/exam/new' element={
                    <ProtectedRoute allowedRoles={['creator']}>
                        <CreateExamPage />
                    </ProtectedRoute>
                } />

                <Route path='/courses/:courseId/exam/:examId' element={
                    <ProtectedRoute allowedRoles={['student']}>
                        <ExamPage />
                    </ProtectedRoute>
                } />
